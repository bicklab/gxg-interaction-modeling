...
parser.add_argument('--covariate_name', '-cn', type=str, required=True, help='Covaraite Name')
...
with open("batch_file.txt") as file, open(output_file, "w") as outfile:
    ...
    for line in file:
        ...
        cmd = f'''dx run app-regenie \
            ...
            -icovar_names="baseline_age,age2,PC1,PC2,PC3,PCD4,PC5,PC6,PC7,PC8,PC9,PC10,{args.covariate_name}" \
            ...
            -istep2_extra_cmd_line_args="--catCovarList genetic_sex --apply-rint --interaction {args.covariate_name}" \
